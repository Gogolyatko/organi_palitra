...
background=transform.scale(image.load('немеция2.jpg'), (700, 500))
...
x2 = 250
y2 = 250
sprite1 = transform.scale(image.load('вентилятор.png'), (100, 100))
sprite2 = transform.scale(image.load('сябакааа.png'), (100, 100))
